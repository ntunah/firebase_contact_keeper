...
class ClientDetails extends Component {
    ...
    onSubmit = e =>{
        ...
        const {balanceUpdated} = this.state

        const clientUpdate ={
            balance: parseFloat(balanceUpdated)
        }
    ...
    render() {
        ...
        const {showBalanceUpdate, balanceUpdated} = this.state
                    ...
                    <div className= "row">
                        ...
                        <div className="col-md-6">
                            <div className="btn-group float-right">
                                ...
                                <button onClick={this.onDeleteClient} className="btn btn-danger">Delete</button>
                            </div>
                        </div>
                    </div>
                    <hr/>
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-4 col-sm-6" >
                                    <h3 className="pull-right">
                                        Balance: <span classnames={classnames({
